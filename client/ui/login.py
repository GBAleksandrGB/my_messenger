# Form implementation generated from reading ui file 'client/ui/login.ui'
#
...
class Ui_Login_Dialog(object):
    def setupUi(self, Login_Dialog):
        ...
        self.username_label = QtWidgets.QLabel(parent=Login_Dialog)
        self.username_label.setObjectName("username_label")
        self.horizontalLayout.addWidget(self.username_label)
        self.username_text = QtWidgets.QLineEdit(parent=Login_Dialog)
        self.username_text.setObjectName("username_text")
        self.horizontalLayout.addWidget(self.username_text)
        self.verticalLayout.addLayout(self.horizontalLayout)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.password_label = QtWidgets.QLabel(parent=Login_Dialog)
        self.password_label.setObjectName("password_label")
        self.horizontalLayout_2.addWidget(self.password_label)
        self.password_text = QtWidgets.QLineEdit(parent=Login_Dialog)
        ...
        self.login_btn = QtWidgets.QPushButton(parent=Login_Dialog)
