...
from client.ui.chat import Ui_ChatMainWindow as chat_ui_class
...
class ContactsWindow(QMainWindow):
    ...
    def on_add_new_contact_btn_pressed(self):
        ...
        if contact_username:
            ...
            QMessageBox.warning(self, 'Error', 'wrong name')
...
class ChatWindow(QMainWindow):
    ...
    def after_start(self):
        self.contact_username = self.parent_window.\
            ui.all_contacts.currentItem().text()
    ...
    def update_chat(self, quantity=10):
