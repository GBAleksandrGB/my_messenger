# Form implementation generated from reading ui file 'client/ui/contacts.ui'
#
...
class Ui_ContactsWindow(object):
    def setupUi(self, ContactsWindow):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=ContactsWindow)
        ...
        self.delete_contact_btn = QtWidgets.QPushButton(parent=self.centralwidget)
        ...
        self.menubar = QtWidgets.QMenuBar(parent=ContactsWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 295, 22))
        self.menubar.setObjectName("menubar")
        self.menuFile = QtWidgets.QMenu(parent=self.menubar)
        self.menuFile.setObjectName("menuFile")
        ContactsWindow.setMenuBar(self.menubar)
        self.statusbar = QtWidgets.QStatusBar(parent=ContactsWindow)
        self.statusbar.setObjectName("statusbar")
        ContactsWindow.setStatusBar(self.statusbar)
        self.actionExit = QtGui.QAction(parent=ContactsWindow)
