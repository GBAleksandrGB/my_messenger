...
class Ui_ChatMainWindow(object):
    def setupUi(self, ChatMainWindow):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=ChatMainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.gridLayout = QtWidgets.QGridLayout(self.centralwidget)
        self.gridLayout.setObjectName("gridLayout")
        self.verticalLayout = QtWidgets.QVBoxLayout()
        self.verticalLayout.setObjectName("verticalLayout")
        self.chat_window = QtWidgets.QListWidget(parent=self.centralwidget)
        self.chat_window.setObjectName("chat_window")
        self.verticalLayout.addWidget(self.chat_window)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.send_text = QtWidgets.QLineEdit(parent=self.centralwidget)
        ...
        self.statusbar = QtWidgets.QStatusBar(parent=ChatMainWindow)
