...
from client.database.connector import DataAccessLayer
from client.database.models import Client, Contacts, History, Messages
...
class ClientMessages:
    ...
    def set_user_offline(self, client_username):
        """Перевод пользователя в оффлайн"""
